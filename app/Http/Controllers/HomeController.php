...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        /*
         * I believe a user roles & permissions feature with a form allowing the client to edit these values should be implemented
         * based on the auth()->user() permissions.
         * */
        $args['hero'] = Copy::where('page', '=', 'home')->first();
    ...
    public function programs()
    {
        ...
        /*Swap Side(A/B) values to customize/reverse img_orientation order*/
        $sideA = 'right';
        $sideB = 'left';
